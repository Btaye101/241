...
### 5.
-     You can try and calculate a 95% confidence interval to see if .3 is contained in he interval. If it is not then you can try to use that to say that the 30% measured is probably not the true value. Additionally you can try 